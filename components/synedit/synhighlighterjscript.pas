...
$Id: synhighlighterjscript.pas 46388 2014-09-30 23:57:55Z martin $
...
begin
  ...
  fNonReservedKeyAttri := TSynHighlighterAttributes.Create(@SYNS_AttrNonReservedKeyword, SYNS_XML_AttrNonReservedKeyword);
  AddAttribute(fNonReservedKeyAttri);
  fEventAttri := TSynHighlighterAttributes.Create(@SYNS_AttrEvent, SYNS_XML_AttrEvent);
