...
begin
  ...
  begin
    ...
    itmHelpUltiboHelp.OnClick := @mnuHelpUltiboHelpClicked; //Ultibo
    itmHelpUltiboForum.OnClick := @mnuHelpUltiboForumClicked; //Ultibo
    itmHelpUltiboWiki.OnClick := @mnuHelpUltiboWikiClicked; //Ultibo
