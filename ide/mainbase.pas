...
begin
  //MainIDEBar.itmFileNewForm.Hint := AHint; //Ultibo
end;
...
begin
  with MainIDEBar do begin
    ...
    //CreateMenuItem(ParentMI,itmFileNewForm,'itmFileNewForm',lisMenuNewForm,'item_form'); //Ultibo
...
begin
  with MainIDEBar do begin
    ...
    //CreateMenuItem(ParentMI,itmViewToggleFormUnit,'itmViewToggleFormUnit',lisMenuViewToggleFormUnit, 'menu_view_toggle_form_unit'); //Ultibo
    //CreateMenuItem(ParentMI,itmViewInspector,'itmViewInspector',lisMenuViewObjectInspector, 'menu_view_inspector'); //Ultibo
    ...
    //CreateMenuItem(ParentMI,itmViewRestrictionBrowser,'itmViewRestrictionBrowser',lisMenuViewRestrictionBrowser, 'menu_view_rectriction_browser'); //Ultibo
    //CreateMenuItem(ParentMI,itmViewComponents,'itmViewComponents',lisMenuViewComponents); //Ultibo
    ...
    //CreateMenuSeparatorSection(mnuView,itmViewDesignerWindows,'itmViewDesignerWindows'); //Ultibo
    //ParentMI:=itmViewDesignerWindows; //Ultibo
    //CreateMenuItem(ParentMI,itmViewAnchorEditor,'itmViewAnchorEditor',lisMenuViewAnchorEditor,'menu_view_anchor_editor'); //Ultibo
    //CreateMenuItem(ParentMI,itmViewTabOrder,'itmViewTabOrder',lisMenuViewTabOrder,'tab_order'); //Ultibo
...
begin
  with MainIDEBar do begin
    ...
    //CreateMenuItem(ParentMI,itmProjectViewForms,'itmProjectViewForms',lisMenuViewForms, 'menu_view_forms'); //Ultibo
...
begin
  with MainIDEBar do begin
    CreateMenuSeparatorSection(mnuComponent,itmPkgOpening,'itmPkgOpening'); //Ultibo
    ParentMI:=itmPkgOpening; //Ultibo
    //CreateMenuItem(ParentMI,itmPkgNewPackage,'itmPkgNewPackage',lisMenuNewPackage); //Ultibo
    //CreateMenuItem(ParentMI,itmPkgOpenLoadedPackage,'itmPkgOpenPackage',lisMenuOpenPackage,'pkg_installed'); //Ultibo
    //CreateMenuItem(ParentMI,itmPkgOpenPackageFile,'itmPkgOpenPackageFile',lisMenuOpenPackageFile,'pkg_open'); //Ultibo
    //CreateMenuItem(ParentMI,itmPkgOpenPackageOfCurUnit,'itmPkgOpenPackageOfCurUnit',lisMenuOpenPackageOfCurUnit); //Ultibo
    CreateMenuSubSection(ParentMI,itmPkgOpenRecent,'itmPkgOpenRecent',lisMenuOpenRecentPkg); //Ultibo

    CreateMenuSeparatorSection(mnuComponent,itmPkgUnits,'itmPkgUnits'); //Ultibo
    ParentMI:=itmPkgUnits; //Ultibo
    //CreateMenuItem(ParentMI,itmPkgAddCurFileToPkg,'itmPkgAddCurFileToPkg',lisMenuAddCurFileToPkg,'pkg_add'); //Ultibo
    //CreateMenuItem(ParentMI, itmPkgAddNewComponentToPkg, 'itmPkgAddNewComponentToPkg', lisMenuNewComponent+' ...', 'pkg_add'); //Ultibo

    CreateMenuSeparatorSection(mnuComponent,itmPkgGraphSection,'itmPkgGraphSection'); //Ultibo
    ParentMI:=itmPkgGraphSection; //Ultibo
    //CreateMenuItem(ParentMI,itmPkgPkgGraph,'itmPkgPkgGraph',lisMenuPackageGraph+' ...','pkg_graph'); //Ultibo
    //CreateMenuItem(ParentMI,itmPkgPackageLinks,'itmPkgPackageLinks',lisMenuPackageLinks); //Ultibo
    //CreateMenuItem(ParentMI,itmPkgEditInstallPkgs,'itmPkgEditInstallPkgs',lisMenuEditInstallPkgs,'pkg_properties'); //Ultibo

    {$IFDEF CustomIDEComps}
    //CreateMenuItem(ParentMI,itmCompsConfigCustomComps,'itmCompsConfigCustomComps',lisMenuConfigCustomComps); //Ultibo
    {$ENDIF}
  end;
end;
...
begin
  with MainIDEBar do begin
    ...
    //CreateMenuItem(ParentMI,itmToolCheckLFM,'itmToolCheckLFM',lisMenuCheckLFM, 'menu_tool_check_lfm'); //Ultibo
    ...
    //CreateMenuItem(ParentMI,itmToolConvertDelphiPackage,'itmToolConvertDelphiPackage',lisMenuConvertDelphiPackage,'menu_tool_dfm_to_lfm'); //Ultibo
    //CreateMenuItem(ParentMI,itmToolConvertDFMtoLFM,'itmToolConvertDFMtoLFM',lisMenuConvertDFMtoLFM,'menu_tool_dfm_to_lfm'); //Ultibo
...
begin
  with MainIDEBar do begin
    CreateMenuSeparatorSection(mnuHelp,itmUltiboHelps,'itmUltiboHelps'); //Ultibo
    ParentMI:=itmUltiboHelps; //Ultibo

    CreateMenuItem(ParentMI,itmHelpUltiboHelp,'itmHelpUltiboHelp',
                   lisMenuUltiboHelp, 'menu_ultibo_help'); //Ultibo
    CreateMenuItem(ParentMI,itmHelpUltiboForum,'itmHelpUltiboForum',
                   lisMenuUltiboForum, 'menu_ultibo_forum'); //Ultibo
    CreateMenuItem(ParentMI,itmHelpUltiboWiki,'itmHelpUltiboWiki',
                   lisMenuUltiboWiki, 'menu_ultibo_wiki'); //Ultibo
...
begin
  with MainIDEBar do begin
    ...
    //itmFileNewForm.Command:=GetCommand(ecNewForm, TNewFormToolButton); //Ultibo
    ...
    // view menu
    //itmViewToggleFormUnit.Command:=GetCommand(ecToggleFormUnit); //Ultibo
    //itmViewInspector.Command:=GetCommand(ecToggleObjectInsp); //Ultibo
    ...
    //itmViewRestrictionBrowser.Command:=GetCommand(ecToggleRestrictionBrowser); //Ultibo
    //itmViewComponents.Command:=GetCommand(ecViewComponents); //Ultibo
    ...
    //itmViewAnchorEditor.Command:=GetCommand(ecViewAnchorEditor); //Ultibo
    //itmViewTabOrder.Command:=GetCommand(ecViewTabOrder); //Ultibo
    ...
    //itmProjectViewForms.Command:=GetCommand(ecViewProjectForms); //Ultibo
    ...
    // package menu
    //itmPkgNewPackage.Command:=GetCommand(ecNewPackage); //Ultibo
    //itmPkgOpenLoadedPackage.Command:=GetCommand(ecOpenPackage); //Ultibo
    //itmPkgOpenPackageFile.Command:=GetCommand(ecOpenPackageFile); //Ultibo
    //itmPkgOpenPackageOfCurUnit.Command:=GetCommand(ecOpenPackageOfCurUnit); //Ultibo
    //itmPkgAddCurFileToPkg.Command:=GetCommand(ecAddCurFileToPkg); //Ultibo
    //itmPkgAddNewComponentToPkg.Command:=GetCommand(ecNewPkgComponent); //Ultibo
    //itmPkgPkgGraph.Command:=GetCommand(ecPackageGraph); //Ultibo
    //itmPkgPackageLinks.Command:=GetCommand(ecPackageLinks); //Ultibo
    //itmPkgEditInstallPkgs.Command:=GetCommand(ecEditInstallPkgs); //Ultibo
    {$IFDEF CustomIDEComps}
    //itmCompsConfigCustomComps.Command:=GetCommand(ecConfigCustomComps); //Ultibo
    {$ENDIF}
    ...
    //itmToolConvertDFMtoLFM.Command:=GetCommand(ecConvertDFM2LFM); //Ultibo
    //itmToolCheckLFM.Command:=GetCommand(ecCheckLFM); //Ultibo
    ...
    //itmToolConvertDelphiPackage.Command:=GetCommand(ecConvertDelphiPackage); //Ultibo
    ...
    itmHelpUltiboHelp.Command:=GetCommand(ecUltiboHelp); //Ultibo
    itmHelpUltiboForum.Command:=GetCommand(ecUltiboForum); //Ultibo
    itmHelpUltiboWiki.Command:=GetCommand(ecUltiboWiki); //Ultibo
  end;
end;
