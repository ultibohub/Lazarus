  ...
  public
    ...
    //mnuComponents: TIDEMenuSection;
      //itmPkgOpening: TIDEMenuSection;
        itmPkgNewPackage: TIDEMenuCommand; //Ultibo
        itmPkgOpenLoadedPackage: TIDEMenuCommand; //Ultibo
        itmPkgOpenPackageFile: TIDEMenuCommand; //Ultibo
        itmPkgOpenPackageOfCurUnit: TIDEMenuCommand; //Ultibo
        //itmPkgOpenRecent: TIDEMenuSection;
      //itmPkgUnits: TIDEMenuSection;
        itmPkgAddCurFileToPkg: TIDEMenuCommand; //Ultibo
        itmPkgAddNewComponentToPkg: TIDEMenuCommand; //Ultibo
      //itmPkgGraphSection: TIDEMenuSection;
        itmPkgPkgGraph: TIDEMenuCommand; //Ultibo
        itmPkgPackageLinks: TIDEMenuCommand; //Ultibo
        itmPkgEditInstallPkgs: TIDEMenuCommand; //Ultibo
        {$IFDEF CustomIDEComps}
        //itmCompsConfigCustomComps: TIDEMenuCommand; //Ultibo
        {$ENDIF}
